...
async function main() {
  ...
  if (mewingImp) {
    await prisma.product.create({
      data: {
        ...
        priceMin: 18,
        priceMax: 35,
        purchaseUrls: '["https://www.amazon.com/s?k=chios+mastic+gum", "https://www.greekinternetmarket.com/mastic-gum"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 8,
        priceMax: 15,
        purchaseUrls: '["https://www.amazon.com/s?k=falim+gum"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 30,
        priceMax: 65,
        purchaseUrls: '["https://www.jawliner.com/", "https://www.amazon.com/s?k=jawliner+gum"]',
  ...
  if (leanmaxImp) {
    await prisma.product.create({
      data: {
        ...
        priceMin: 10,
        priceMax: 20,
        purchaseUrls: '["https://www.amazon.com/s?k=etekcity+food+scale"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 28,
        priceMax: 40,
        purchaseUrls: '["https://www.amazon.com/s?k=mount+lai+gua+sha", "https://www.sephora.com/search?keyword=gua%20sha"]',
  ...
  if (skincareImp) {
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 20,
        priceMax: 100,
        purchaseUrls: '["https://curology.com/", "https://www.apostrophe.com/"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 12,
        priceMax: 30,
        purchaseUrls: '["https://www.amazon.com/s?k=cerave+hydrating+cleanser", "https://www.target.com/s?searchTerm=cerave+cleanser"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 35,
        priceMax: 42,
        purchaseUrls: '["https://www.amazon.com/s?k=cerave+moisturizer", "https://www.dermstore.com/search?q=cerave"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 30,
        priceMax: 35,
        purchaseUrls: '["https://www.paulaschoice.com/", "https://www.amazon.com/s?k=paulas+choice+bha"]',
    ...
    await prisma.product.create({
      data: {
        ...
        priceMin: 6,
        priceMax: 10,
        purchaseUrls: '["https://theordinary.com/", "https://www.amazon.com/s?k=the+ordinary+vitamin+c"]',
  ...
  // SURGERY / HARDMAX research links (not purchase — RealSelf consult info)
  const surgeryImpNames = [
    { match: 'Custom Jaw Implants', url: 'https://www.realself.com/surgical/jaw-implants', name: 'Jaw Implants: Find a Surgeon', costMin: 15000, costMax: 45000 },
    { match: 'Bimax Surgery', url: 'https://www.realself.com/surgical/jaw-surgery', name: 'Jaw Surgery (Bimax): Research', costMin: 30000, costMax: 80000 },
    { match: 'Canthoplasty', url: 'https://www.realself.com/surgical/canthoplasty', name: 'Canthoplasty: Find a Surgeon', costMin: 4000, costMax: 12000 },
    { match: 'Cheek/Malar Implants', url: 'https://www.realself.com/surgical/cheek-implants', name: 'Cheek Implants: Research', costMin: 6000, costMax: 15000 },
    { match: 'Rhinoplasty', url: 'https://www.realself.com/surgical/rhinoplasty', name: 'Rhinoplasty: Find a Surgeon', costMin: 6000, costMax: 18000 },
    { match: 'Lip Lift Surgery', url: 'https://www.realself.com/surgical/lip-lift', name: 'Lip Lift: Research', costMin: 4000, costMax: 8000 },
    { match: 'Buccal Fat Removal', url: 'https://www.realself.com/surgical/buccal-fat-removal', name: 'Buccal Fat Removal: Research', costMin: 3000, costMax: 8000 },
    { match: 'FUE Hair Transplant', url: 'https://www.realself.com/surgical/fue-hair-transplant', name: 'FUE Hair Transplant: Research', costMin: 8000, costMax: 25000 },
    { match: 'Fractional CO2', url: 'https://www.realself.com/nonsurgical/fractional-laser', name: 'CO2 Laser Resurfacing: Research', costMin: 1500, costMax: 5000 },
  ];

  for (const s of surgeryImpNames) {
    const imp = await prisma.improvement.findFirst({ where: { name: { contains: s.match } } });
    if (!imp) continue;
    await prisma.product.create({
      data: {
        name: s.name,
        ...
        priceMin: s.costMin,
        priceMax: s.costMax,
        purchaseUrls: JSON.stringify([s.url]),
        effectivenessRating: 8.5,
        riskLevel: 'high',
        usageInstructions: 'Research board-certified surgeons on RealSelf. Book consultations before committing.',
        timelineToResults: 'Varies by procedure',
        improvements: { connect: { id: imp.id } },
      },
    });
  }
